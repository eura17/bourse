...
box.schema.user.grant('robot', 'execute', 'function', 'get_min_ask_price_from_order_book')
...
box.schema.user.grant('robot', 'execute', 'function', 'get_max_bid_price_from_order_book')
